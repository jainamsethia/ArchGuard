...
def test_finalize_result_filters_suppressed_violations(monkeypatch):
    ...
    # Signature mirrors _filter_suppressed, including the suppressed_hashes the
    # orchestrator forwards -- the user's own suppressions, read from PostgreSQL
    # before the run rather than from the throwaway clone.
