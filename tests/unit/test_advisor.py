...
def test_advisor_builds_context_correctly():
    ...
    runs = [
        {"score": 50.0},
        {
            ...
            "band": "WARN",
            "violations": [
                {"layer": 1, "module": "auth", "message": "Illegal import", "severity": "high"},
                {"layer": 2, "module": "utils", "message": "Too complex", "severity": "low"}
            ],
            "metrics": {
                "layer_scores": {"1": 60.0, "2": 90.0},
                "fitness_results": [
                    {"name": "No cycles", "passed": True},
                    {"name": "Max DB connections", "passed": False, "evidence": "Found 15 connections"}
                ]
            },
