...
def mock_tracker():
    with patch("archguard.evolution.tracker.ArchitectureEvolutionTracker") as mock_cls:
        ...
        s1 = CommitHealthSnapshot(sha="abc1234", committed_at="2023-01-01T10:00:00Z", health_score=90.0, composite_score=90.0, layer_scores={}, violation_count=2, author="Alice", message="Init")
        s2 = CommitHealthSnapshot(sha="def5678", committed_at="2023-01-02T10:00:00Z", health_score=80.0, composite_score=80.0, layer_scores={}, violation_count=5, author="Bob", message="Add bug")
