...
class GitWorktreeManager:
    ...
    def __init__(self, repo_path: Path | str, base_worktree_dir: Path | str | None = None) -> None:
            ...
            try:
                ...
                def onerror(func: Any, path: str, exc_info: Any) -> None:
                    ...
                    if not os.access(path, os.W_OK):
                        ...
                        raise
                shutil.rmtree(wt_path, onexc=onerror) if hasattr(shutil, "onexc") else shutil.rmtree(wt_path, onerror=onerror)
            except Exception as e:
                logger.warning(f"Failed to manually remove worktree directory {wt_path}: {e}")
                success = False
